...
<head>
  ...
  <title>Dashboard | SMP ISLAM NURUSH SHODIQIN</title>
              ...
              <div class="card border-left-success shadow h-100 py-2">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">DATA <br>GURU</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jumlah_siswa?> (Guru)</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4 ">
              ...
              <a href="lihatkelas.php" style="text-decoration:none;">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">LIST <br> IZIN</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jumlah_kelas?> (Izin)</div>
                    </div>
                    <div class="col-auto">
         ...
         <div class="col-xl-3 col-md-6 mb-4 ">
              ...
              <a href="lihatmatkul.php" style="text-decoration:none;">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">DAFTAR <br> MATA PELAJARAN</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$jumlah_matkul?> (Mata Pelajaran)</div>
                    </div>
                    <div class="col-auto">
         ...
         <div class="col-xl-3 col-md-6 mb-4 ">
              ...
              <a href="#" style="text-decoration:none;" data-toggle="modal" data-target="#comingModal">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">DAFTAR  <br> PENILAIAN</div>
